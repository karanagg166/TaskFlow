...
const TaskList: FC = () => {
  ...
  return (
    <div className="container mx-auto min-h-screen flex flex-col justify-center" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {currentTasks.map((task) => (
            <motion.div
              ...
              key={task._id}
            >
              <Link to={`/user/task/${task._id}`} state={{ task }} className="block">
